...
<form id="companyForm">
	<fieldset>
		...
		<div class="row-fluid">
			<c:if test="${company.id gt 0}">
				<div class="span6">
					...
					${company.id } <input type="hidden" id="id" name="id"
						value="${company.id }" />
				</div>
			</c:if>
			<div class="span6">
				<label for="name"> Name<span class="required">*</span>
				</label> <input type="text" id="name" name="name" class="span12"
					value="${company.name }">
			</div>
		</div>
		<div class="row-fluid">
		...
		<div class="row-fluid">
			<div class="span6">
				<label for="subscriptionDate"> Subscription Date<span
					class="required">*</span>
				</label> <input type="text" id="subscriptionDate" name="subscriptionDate"
					class="span12" value="${company.subscriptionDate }">
			</div>
			<c:if test="${company.id gt 0}">
				<div class="span6">
					<label for="createdon"> Created On<span class="required">*</span>
					</label>
	...
	<div class="row-fluid">
		<button type="button" id="submit" class="btn btn-primary">${company.id
