	...
	<fieldset>
		...
		<div class="row-fluid">
			<c:if test="${product.id gt 0}">
				<div class="span6">
					<label for="id"> Id </label> ${product.id } <input type="hidden"
		...
		<div class="row-fluid">
			<div class="span6">
				<label for="company"> Company<span class="required">*</span>
				</label> <select id="company" name="company" class="span12">
		...
		<div class="row-fluid">
			<div class="span6">
				<label for="keyword"> Keyword <span class="required">*</span>
				</label>
